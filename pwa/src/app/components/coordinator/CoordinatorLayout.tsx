...
export function CoordinatorLayout() {
  ...
  const isActive = (path: string) => {
    ...
    if (path !== "/coordinator" && location.pathname.startsWith(path)) return true;
    return false;
  };
  ...
  const navItems = [
    ...
    { path: "/coordinator/doctors", label: "Lekarze", icon: Users },
    { path: "/coordinator/metrics", label: "Raporty i metryki", icon: BarChart3 },
    { path: "/coordinator/audit", label: "Audyt", icon: Shield },
  ];
